...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/3-1.o
POSSIBLE_DEPFILES=${OBJECTDIR}/3-1.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/3-1.o
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/3-1.o: 3-1.asm  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/3-1.o.d 
	@${RM} ${OBJECTDIR}/3-1.o 
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/3-1.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_SIMULATOR=1 -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/3-1.lst\" -e\"${OBJECTDIR}/3-1.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/3-1.o\" \"3-1.asm\" 
	@${DEP_GEN} -d "${OBJECTDIR}/3-1.o"
	@${FIXDEPS} "${OBJECTDIR}/3-1.o.d" $(SILENT) -rsi ${MP_AS_DIR} -c18 
...
${OBJECTDIR}/3-1.o: 3-1.asm  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/3-1.o.d 
	@${RM} ${OBJECTDIR}/3-1.o 
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/3-1.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/3-1.lst\" -e\"${OBJECTDIR}/3-1.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/3-1.o\" \"3-1.asm\" 
	@${DEP_GEN} -d "${OBJECTDIR}/3-1.o"
	@${FIXDEPS} "${OBJECTDIR}/3-1.o.d" $(SILENT) -rsi ${MP_AS_DIR} -c18 
